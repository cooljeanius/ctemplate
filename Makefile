...
pkgdatadir = $(datadir)/ctemplate
pkgincludedir = $(includedir)/ctemplate
pkglibdir = $(libdir)/ctemplate
pkglibexecdir = $(libexecdir)/ctemplate
...
#am__append_1 = src/windows/port.h src/windows/port.cc
...
DIST_COMMON = $(srcdir)/Makefile.am $(top_srcdir)/configure \
	$(am__configure_deps) $(dist_doc_DATA) $(noinst_HEADERS) \
	$(am__DIST_COMMON)
...
#am__objects_2 = src/windows/libctemplate_la-port.lo
...
am__libctemplate_debug_la_SOURCES_DIST = src/ctemplate/template.h \
	...
	src/htmlparser/statemachine.cc src/htmlparser/statemachine.h \
	src/windows/port.h src/windows/port.cc
#am__objects_3 = src/windows/libctemplate_debug_la-port.lo
...
am__libctemplate_nothreads_debug_la_SOURCES_DIST =  \
	...
	src/htmlparser/statemachine.cc src/htmlparser/statemachine.h \
	src/windows/port.h src/windows/port.cc
#am__objects_7 = src/windows/libctemplate_nothreads_debug_la-port.lo
...
am__depfiles_remade = ./$(DEPDIR)/statemachine_test-statemachine.Po \
	src/$(DEPDIR)/diff_tpl_auto_escape.Po \
	src/$(DEPDIR)/libctemplate_debug_la-per_expand_data.Plo \
	src/$(DEPDIR)/libctemplate_debug_la-template.Plo \
	src/$(DEPDIR)/libctemplate_debug_la-template_annotator.Plo \
	src/$(DEPDIR)/libctemplate_debug_la-template_cache.Plo \
	src/$(DEPDIR)/libctemplate_debug_la-template_dictionary.Plo \
	src/$(DEPDIR)/libctemplate_debug_la-template_modifiers.Plo \
	src/$(DEPDIR)/libctemplate_debug_la-template_namelist.Plo \
	src/$(DEPDIR)/libctemplate_debug_la-template_pathops.Plo \
	src/$(DEPDIR)/libctemplate_debug_la-template_string.Plo \
	src/$(DEPDIR)/libctemplate_la-per_expand_data.Plo \
	src/$(DEPDIR)/libctemplate_la-template.Plo \
	src/$(DEPDIR)/libctemplate_la-template_annotator.Plo \
	src/$(DEPDIR)/libctemplate_la-template_cache.Plo \
	src/$(DEPDIR)/libctemplate_la-template_dictionary.Plo \
	src/$(DEPDIR)/libctemplate_la-template_modifiers.Plo \
	src/$(DEPDIR)/libctemplate_la-template_namelist.Plo \
	src/$(DEPDIR)/libctemplate_la-template_pathops.Plo \
	src/$(DEPDIR)/libctemplate_la-template_string.Plo \
	src/$(DEPDIR)/libctemplate_nothreads_debug_la-per_expand_data.Plo \
	src/$(DEPDIR)/libctemplate_nothreads_debug_la-template.Plo \
	src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_annotator.Plo \
	src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_cache.Plo \
	src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_dictionary.Plo \
	src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_modifiers.Plo \
	src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_namelist.Plo \
	src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_pathops.Plo \
	src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_string.Plo \
	src/$(DEPDIR)/libctemplate_nothreads_la-per_expand_data.Plo \
	src/$(DEPDIR)/libctemplate_nothreads_la-template.Plo \
	src/$(DEPDIR)/libctemplate_nothreads_la-template_annotator.Plo \
	src/$(DEPDIR)/libctemplate_nothreads_la-template_cache.Plo \
	src/$(DEPDIR)/libctemplate_nothreads_la-template_dictionary.Plo \
	src/$(DEPDIR)/libctemplate_nothreads_la-template_modifiers.Plo \
	src/$(DEPDIR)/libctemplate_nothreads_la-template_namelist.Plo \
	src/$(DEPDIR)/libctemplate_nothreads_la-template_pathops.Plo \
	src/$(DEPDIR)/libctemplate_nothreads_la-template_string.Plo \
	src/$(DEPDIR)/make_tpl_varnames_h.Po \
	src/$(DEPDIR)/template_test_util_nothreads_test-template_dictionary.Po \
	src/$(DEPDIR)/template_test_util_test-template_dictionary.Po \
	src/base/$(DEPDIR)/libctemplate_debug_la-arena.Plo \
	src/base/$(DEPDIR)/libctemplate_la-arena.Plo \
	src/base/$(DEPDIR)/libctemplate_nothreads_debug_la-arena.Plo \
	src/base/$(DEPDIR)/libctemplate_nothreads_la-arena.Plo \
	src/htmlparser/$(DEPDIR)/libctemplate_debug_la-htmlparser.Plo \
	src/htmlparser/$(DEPDIR)/libctemplate_debug_la-jsparser.Plo \
	src/htmlparser/$(DEPDIR)/libctemplate_debug_la-statemachine.Plo \
	src/htmlparser/$(DEPDIR)/libctemplate_la-htmlparser.Plo \
	src/htmlparser/$(DEPDIR)/libctemplate_la-jsparser.Plo \
	src/htmlparser/$(DEPDIR)/libctemplate_la-statemachine.Plo \
	src/htmlparser/$(DEPDIR)/libctemplate_nothreads_debug_la-htmlparser.Plo \
	src/htmlparser/$(DEPDIR)/libctemplate_nothreads_debug_la-jsparser.Plo \
	src/htmlparser/$(DEPDIR)/libctemplate_nothreads_debug_la-statemachine.Plo \
	src/htmlparser/$(DEPDIR)/libctemplate_nothreads_la-htmlparser.Plo \
	src/htmlparser/$(DEPDIR)/libctemplate_nothreads_la-jsparser.Plo \
	src/htmlparser/$(DEPDIR)/libctemplate_nothreads_la-statemachine.Plo \
	src/tests/$(DEPDIR)/compile_nothreads_test-compile_test.Po \
	src/tests/$(DEPDIR)/compile_test-compile_test.Po \
	src/tests/$(DEPDIR)/generate_fsm_c_test.Po \
	src/tests/$(DEPDIR)/htmlparser_nothreads_test-htmlparser_cpp_test.Po \
	src/tests/$(DEPDIR)/htmlparser_test-htmlparser_cpp_test.Po \
	src/tests/$(DEPDIR)/libctemplate_testing_la-template_test_util.Plo \
	src/tests/$(DEPDIR)/libctemplate_testing_nothreads_la-template_test_util.Plo \
	src/tests/$(DEPDIR)/statemachine_test-statemachine_test.Po \
	src/tests/$(DEPDIR)/template_cache_nothreads_test-template_cache_test.Po \
	src/tests/$(DEPDIR)/template_cache_test-template_cache_test.Po \
	src/tests/$(DEPDIR)/template_dictionary_nothreads_unittest-template_dictionary_unittest.Po \
	src/tests/$(DEPDIR)/template_dictionary_unittest-template_dictionary_unittest.Po \
	src/tests/$(DEPDIR)/template_modifiers_nothreads_unittest-template_modifiers_unittest.Po \
	src/tests/$(DEPDIR)/template_modifiers_unittest-template_modifiers_unittest.Po \
	src/tests/$(DEPDIR)/template_nothreads_regtest-template_regtest.Po \
	src/tests/$(DEPDIR)/template_nothreads_unittest-template_unittest.Po \
	src/tests/$(DEPDIR)/template_regtest-template_regtest.Po \
	src/tests/$(DEPDIR)/template_setglobals_nothreads_unittest-template_setglobals_unittest.Po \
	src/tests/$(DEPDIR)/template_setglobals_unittest-template_setglobals_unittest.Po \
	src/tests/$(DEPDIR)/template_test_util_nothreads_test-template_test_util_test.Po \
	src/tests/$(DEPDIR)/template_test_util_test-template_test_util_test.Po \
	src/tests/$(DEPDIR)/template_unittest-template_unittest.Po \
	src/windows/$(DEPDIR)/libctemplate_debug_la-port.Plo \
	src/windows/$(DEPDIR)/libctemplate_la-port.Plo \
	src/windows/$(DEPDIR)/libctemplate_nothreads_debug_la-port.Plo \
	src/windows/$(DEPDIR)/libctemplate_nothreads_la-port.Plo
am__mv = mv -f
...
ACLOCAL = ${SHELL} '/Users/ericgallager/Documents/GitHub/ctemplate/build-aux/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} '/Users/ericgallager/Documents/GitHub/ctemplate/build-aux/missing' autoconf
AUTOHEADER = ${SHELL} '/Users/ericgallager/Documents/GitHub/ctemplate/build-aux/missing' autoheader
AUTOMAKE = ${SHELL} '/Users/ericgallager/Documents/GitHub/ctemplate/build-aux/missing' automake-1.16
AWK = gawk
CC = gcc
...
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} '/Users/ericgallager/Documents/GitHub/ctemplate/build-aux/missing' makeinfo
MANIFEST_TOOL = :
...
STRIP = strip
VERSION = 2.2
abs_builddir = /Users/ericgallager/Documents/GitHub/ctemplate
abs_srcdir = /Users/ericgallager/Documents/GitHub/ctemplate
abs_top_builddir = /Users/ericgallager/Documents/GitHub/ctemplate
abs_top_srcdir = /Users/ericgallager/Documents/GitHub/ctemplate
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
ac_cv_cxx_hash_map = <unordered_map>
ac_cv_cxx_hash_map_class = std::unordered_map
ac_cv_cxx_hash_set = <unordered_set>
ac_cv_cxx_hash_set_class = std::unordered_set
ac_cv_have_inttypes_h = 1
ac_cv_have_stdint_h = 1
ac_cv_uint64 = u_int64_t
ac_google_attribute = 0
ac_google_end_namespace = }
ac_google_namespace = ::ctemplate
ac_google_start_namespace = namespace ctemplate {
...
install_sh = ${SHELL} /Users/ericgallager/Documents/GitHub/ctemplate/build-aux/install-sh
...
include ./$(DEPDIR)/statemachine_test-statemachine.Po # am--include-marker
include src/$(DEPDIR)/diff_tpl_auto_escape.Po # am--include-marker
include src/$(DEPDIR)/libctemplate_debug_la-per_expand_data.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_debug_la-template.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_debug_la-template_annotator.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_debug_la-template_cache.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_debug_la-template_dictionary.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_debug_la-template_modifiers.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_debug_la-template_namelist.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_debug_la-template_pathops.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_debug_la-template_string.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_la-per_expand_data.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_la-template.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_la-template_annotator.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_la-template_cache.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_la-template_dictionary.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_la-template_modifiers.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_la-template_namelist.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_la-template_pathops.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_la-template_string.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_nothreads_debug_la-per_expand_data.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_nothreads_debug_la-template.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_annotator.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_cache.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_dictionary.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_modifiers.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_namelist.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_pathops.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_string.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_nothreads_la-per_expand_data.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_nothreads_la-template.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_nothreads_la-template_annotator.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_nothreads_la-template_cache.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_nothreads_la-template_dictionary.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_nothreads_la-template_modifiers.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_nothreads_la-template_namelist.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_nothreads_la-template_pathops.Plo # am--include-marker
include src/$(DEPDIR)/libctemplate_nothreads_la-template_string.Plo # am--include-marker
include src/$(DEPDIR)/make_tpl_varnames_h.Po # am--include-marker
include src/$(DEPDIR)/template_test_util_nothreads_test-template_dictionary.Po # am--include-marker
include src/$(DEPDIR)/template_test_util_test-template_dictionary.Po # am--include-marker
include src/base/$(DEPDIR)/libctemplate_debug_la-arena.Plo # am--include-marker
include src/base/$(DEPDIR)/libctemplate_la-arena.Plo # am--include-marker
include src/base/$(DEPDIR)/libctemplate_nothreads_debug_la-arena.Plo # am--include-marker
include src/base/$(DEPDIR)/libctemplate_nothreads_la-arena.Plo # am--include-marker
include src/htmlparser/$(DEPDIR)/libctemplate_debug_la-htmlparser.Plo # am--include-marker
include src/htmlparser/$(DEPDIR)/libctemplate_debug_la-jsparser.Plo # am--include-marker
include src/htmlparser/$(DEPDIR)/libctemplate_debug_la-statemachine.Plo # am--include-marker
include src/htmlparser/$(DEPDIR)/libctemplate_la-htmlparser.Plo # am--include-marker
include src/htmlparser/$(DEPDIR)/libctemplate_la-jsparser.Plo # am--include-marker
include src/htmlparser/$(DEPDIR)/libctemplate_la-statemachine.Plo # am--include-marker
include src/htmlparser/$(DEPDIR)/libctemplate_nothreads_debug_la-htmlparser.Plo # am--include-marker
include src/htmlparser/$(DEPDIR)/libctemplate_nothreads_debug_la-jsparser.Plo # am--include-marker
include src/htmlparser/$(DEPDIR)/libctemplate_nothreads_debug_la-statemachine.Plo # am--include-marker
include src/htmlparser/$(DEPDIR)/libctemplate_nothreads_la-htmlparser.Plo # am--include-marker
include src/htmlparser/$(DEPDIR)/libctemplate_nothreads_la-jsparser.Plo # am--include-marker
include src/htmlparser/$(DEPDIR)/libctemplate_nothreads_la-statemachine.Plo # am--include-marker
include src/tests/$(DEPDIR)/compile_nothreads_test-compile_test.Po # am--include-marker
include src/tests/$(DEPDIR)/compile_test-compile_test.Po # am--include-marker
include src/tests/$(DEPDIR)/generate_fsm_c_test.Po # am--include-marker
include src/tests/$(DEPDIR)/htmlparser_nothreads_test-htmlparser_cpp_test.Po # am--include-marker
include src/tests/$(DEPDIR)/htmlparser_test-htmlparser_cpp_test.Po # am--include-marker
include src/tests/$(DEPDIR)/libctemplate_testing_la-template_test_util.Plo # am--include-marker
include src/tests/$(DEPDIR)/libctemplate_testing_nothreads_la-template_test_util.Plo # am--include-marker
include src/tests/$(DEPDIR)/statemachine_test-statemachine_test.Po # am--include-marker
include src/tests/$(DEPDIR)/template_cache_nothreads_test-template_cache_test.Po # am--include-marker
include src/tests/$(DEPDIR)/template_cache_test-template_cache_test.Po # am--include-marker
include src/tests/$(DEPDIR)/template_dictionary_nothreads_unittest-template_dictionary_unittest.Po # am--include-marker
include src/tests/$(DEPDIR)/template_dictionary_unittest-template_dictionary_unittest.Po # am--include-marker
include src/tests/$(DEPDIR)/template_modifiers_nothreads_unittest-template_modifiers_unittest.Po # am--include-marker
include src/tests/$(DEPDIR)/template_modifiers_unittest-template_modifiers_unittest.Po # am--include-marker
include src/tests/$(DEPDIR)/template_nothreads_regtest-template_regtest.Po # am--include-marker
include src/tests/$(DEPDIR)/template_nothreads_unittest-template_unittest.Po # am--include-marker
include src/tests/$(DEPDIR)/template_regtest-template_regtest.Po # am--include-marker
include src/tests/$(DEPDIR)/template_setglobals_nothreads_unittest-template_setglobals_unittest.Po # am--include-marker
include src/tests/$(DEPDIR)/template_setglobals_unittest-template_setglobals_unittest.Po # am--include-marker
include src/tests/$(DEPDIR)/template_test_util_nothreads_test-template_test_util_test.Po # am--include-marker
include src/tests/$(DEPDIR)/template_test_util_test-template_test_util_test.Po # am--include-marker
include src/tests/$(DEPDIR)/template_unittest-template_unittest.Po # am--include-marker
include src/windows/$(DEPDIR)/libctemplate_debug_la-port.Plo # am--include-marker
include src/windows/$(DEPDIR)/libctemplate_la-port.Plo # am--include-marker
include src/windows/$(DEPDIR)/libctemplate_nothreads_debug_la-port.Plo # am--include-marker
include src/windows/$(DEPDIR)/libctemplate_nothreads_la-port.Plo # am--include-marker
...
src/tests/statemachine_test-statemachine_test.o: src/tests/statemachine_test.c
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/statemachine_test-statemachine_test.Tpo src/tests/$(DEPDIR)/statemachine_test-statemachine_test.Po
#	$(AM_V_CC)source='src/tests/statemachine_test.c' object='src/tests/statemachine_test-statemachine_test.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(statemachine_test_CFLAGS) $(CFLAGS) -c -o src/tests/statemachine_test-statemachine_test.o `test -f 'src/tests/statemachine_test.c' || echo '$(srcdir)/'`src/tests/statemachine_test.c
...
src/tests/statemachine_test-statemachine_test.obj: src/tests/statemachine_test.c
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/statemachine_test-statemachine_test.Tpo src/tests/$(DEPDIR)/statemachine_test-statemachine_test.Po
#	$(AM_V_CC)source='src/tests/statemachine_test.c' object='src/tests/statemachine_test-statemachine_test.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(statemachine_test_CFLAGS) $(CFLAGS) -c -o src/tests/statemachine_test-statemachine_test.obj `if test -f 'src/tests/statemachine_test.c'; then $(CYGPATH_W) 'src/tests/statemachine_test.c'; else $(CYGPATH_W) '$(srcdir)/src/tests/statemachine_test.c'; fi`

statemachine_test-statemachine.o: statemachine.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(statemachine_test_CFLAGS) $(CFLAGS) -MT statemachine_test-statemachine.o -MD -MP -MF $(DEPDIR)/statemachine_test-statemachine.Tpo -c -o statemachine_test-statemachine.o `test -f 'statemachine.c' || echo '$(srcdir)/'`statemachine.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/statemachine_test-statemachine.Tpo $(DEPDIR)/statemachine_test-statemachine.Po
#	$(AM_V_CC)source='statemachine.c' object='statemachine_test-statemachine.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(statemachine_test_CFLAGS) $(CFLAGS) -c -o statemachine_test-statemachine.o `test -f 'statemachine.c' || echo '$(srcdir)/'`statemachine.c
...
statemachine_test-statemachine.obj: statemachine.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/statemachine_test-statemachine.Tpo $(DEPDIR)/statemachine_test-statemachine.Po
#	$(AM_V_CC)source='statemachine.c' object='statemachine_test-statemachine.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(statemachine_test_CFLAGS) $(CFLAGS) -c -o statemachine_test-statemachine.obj `if test -f 'statemachine.c'; then $(CYGPATH_W) 'statemachine.c'; else $(CYGPATH_W) '$(srcdir)/statemachine.c'; fi`
...
src/base/libctemplate_la-arena.lo: src/base/arena.cc
	...
	$(AM_V_at)$(am__mv) src/base/$(DEPDIR)/libctemplate_la-arena.Tpo src/base/$(DEPDIR)/libctemplate_la-arena.Plo
#	$(AM_V_CXX)source='src/base/arena.cc' object='src/base/libctemplate_la-arena.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_la_CXXFLAGS) $(CXXFLAGS) -c -o src/base/libctemplate_la-arena.lo `test -f 'src/base/arena.cc' || echo '$(srcdir)/'`src/base/arena.cc
...
src/libctemplate_la-per_expand_data.lo: src/per_expand_data.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_la-per_expand_data.Tpo src/$(DEPDIR)/libctemplate_la-per_expand_data.Plo
#	$(AM_V_CXX)source='src/per_expand_data.cc' object='src/libctemplate_la-per_expand_data.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_la_CXXFLAGS) $(CXXFLAGS) -c -o src/libctemplate_la-per_expand_data.lo `test -f 'src/per_expand_data.cc' || echo '$(srcdir)/'`src/per_expand_data.cc
...
src/libctemplate_la-template.lo: src/template.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_la-template.Tpo src/$(DEPDIR)/libctemplate_la-template.Plo
#	$(AM_V_CXX)source='src/template.cc' object='src/libctemplate_la-template.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_la_CXXFLAGS) $(CXXFLAGS) -c -o src/libctemplate_la-template.lo `test -f 'src/template.cc' || echo '$(srcdir)/'`src/template.cc
...
src/libctemplate_la-template_annotator.lo: src/template_annotator.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_la-template_annotator.Tpo src/$(DEPDIR)/libctemplate_la-template_annotator.Plo
#	$(AM_V_CXX)source='src/template_annotator.cc' object='src/libctemplate_la-template_annotator.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_la_CXXFLAGS) $(CXXFLAGS) -c -o src/libctemplate_la-template_annotator.lo `test -f 'src/template_annotator.cc' || echo '$(srcdir)/'`src/template_annotator.cc
...
src/libctemplate_la-template_cache.lo: src/template_cache.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_la-template_cache.Tpo src/$(DEPDIR)/libctemplate_la-template_cache.Plo
#	$(AM_V_CXX)source='src/template_cache.cc' object='src/libctemplate_la-template_cache.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_la_CXXFLAGS) $(CXXFLAGS) -c -o src/libctemplate_la-template_cache.lo `test -f 'src/template_cache.cc' || echo '$(srcdir)/'`src/template_cache.cc
...
src/libctemplate_la-template_dictionary.lo: src/template_dictionary.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_la-template_dictionary.Tpo src/$(DEPDIR)/libctemplate_la-template_dictionary.Plo
#	$(AM_V_CXX)source='src/template_dictionary.cc' object='src/libctemplate_la-template_dictionary.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_la_CXXFLAGS) $(CXXFLAGS) -c -o src/libctemplate_la-template_dictionary.lo `test -f 'src/template_dictionary.cc' || echo '$(srcdir)/'`src/template_dictionary.cc
...
src/libctemplate_la-template_modifiers.lo: src/template_modifiers.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_la-template_modifiers.Tpo src/$(DEPDIR)/libctemplate_la-template_modifiers.Plo
#	$(AM_V_CXX)source='src/template_modifiers.cc' object='src/libctemplate_la-template_modifiers.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_la_CXXFLAGS) $(CXXFLAGS) -c -o src/libctemplate_la-template_modifiers.lo `test -f 'src/template_modifiers.cc' || echo '$(srcdir)/'`src/template_modifiers.cc
...
src/libctemplate_la-template_namelist.lo: src/template_namelist.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_la-template_namelist.Tpo src/$(DEPDIR)/libctemplate_la-template_namelist.Plo
#	$(AM_V_CXX)source='src/template_namelist.cc' object='src/libctemplate_la-template_namelist.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_la_CXXFLAGS) $(CXXFLAGS) -c -o src/libctemplate_la-template_namelist.lo `test -f 'src/template_namelist.cc' || echo '$(srcdir)/'`src/template_namelist.cc
...
src/libctemplate_la-template_pathops.lo: src/template_pathops.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_la-template_pathops.Tpo src/$(DEPDIR)/libctemplate_la-template_pathops.Plo
#	$(AM_V_CXX)source='src/template_pathops.cc' object='src/libctemplate_la-template_pathops.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_la_CXXFLAGS) $(CXXFLAGS) -c -o src/libctemplate_la-template_pathops.lo `test -f 'src/template_pathops.cc' || echo '$(srcdir)/'`src/template_pathops.cc
...
src/libctemplate_la-template_string.lo: src/template_string.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_la-template_string.Tpo src/$(DEPDIR)/libctemplate_la-template_string.Plo
#	$(AM_V_CXX)source='src/template_string.cc' object='src/libctemplate_la-template_string.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_la_CXXFLAGS) $(CXXFLAGS) -c -o src/libctemplate_la-template_string.lo `test -f 'src/template_string.cc' || echo '$(srcdir)/'`src/template_string.cc
...
src/htmlparser/libctemplate_la-htmlparser.lo: src/htmlparser/htmlparser.cc
	...
	$(AM_V_at)$(am__mv) src/htmlparser/$(DEPDIR)/libctemplate_la-htmlparser.Tpo src/htmlparser/$(DEPDIR)/libctemplate_la-htmlparser.Plo
#	$(AM_V_CXX)source='src/htmlparser/htmlparser.cc' object='src/htmlparser/libctemplate_la-htmlparser.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_la_CXXFLAGS) $(CXXFLAGS) -c -o src/htmlparser/libctemplate_la-htmlparser.lo `test -f 'src/htmlparser/htmlparser.cc' || echo '$(srcdir)/'`src/htmlparser/htmlparser.cc
...
src/htmlparser/libctemplate_la-jsparser.lo: src/htmlparser/jsparser.cc
	...
	$(AM_V_at)$(am__mv) src/htmlparser/$(DEPDIR)/libctemplate_la-jsparser.Tpo src/htmlparser/$(DEPDIR)/libctemplate_la-jsparser.Plo
#	$(AM_V_CXX)source='src/htmlparser/jsparser.cc' object='src/htmlparser/libctemplate_la-jsparser.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_la_CXXFLAGS) $(CXXFLAGS) -c -o src/htmlparser/libctemplate_la-jsparser.lo `test -f 'src/htmlparser/jsparser.cc' || echo '$(srcdir)/'`src/htmlparser/jsparser.cc
...
src/htmlparser/libctemplate_la-statemachine.lo: src/htmlparser/statemachine.cc
	...
	$(AM_V_at)$(am__mv) src/htmlparser/$(DEPDIR)/libctemplate_la-statemachine.Tpo src/htmlparser/$(DEPDIR)/libctemplate_la-statemachine.Plo
#	$(AM_V_CXX)source='src/htmlparser/statemachine.cc' object='src/htmlparser/libctemplate_la-statemachine.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_la_CXXFLAGS) $(CXXFLAGS) -c -o src/htmlparser/libctemplate_la-statemachine.lo `test -f 'src/htmlparser/statemachine.cc' || echo '$(srcdir)/'`src/htmlparser/statemachine.cc
...
src/windows/libctemplate_la-port.lo: src/windows/port.cc
	...
	$(AM_V_at)$(am__mv) src/windows/$(DEPDIR)/libctemplate_la-port.Tpo src/windows/$(DEPDIR)/libctemplate_la-port.Plo
#	$(AM_V_CXX)source='src/windows/port.cc' object='src/windows/libctemplate_la-port.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_la_CXXFLAGS) $(CXXFLAGS) -c -o src/windows/libctemplate_la-port.lo `test -f 'src/windows/port.cc' || echo '$(srcdir)/'`src/windows/port.cc
...
src/base/libctemplate_debug_la-arena.lo: src/base/arena.cc
	...
	$(AM_V_at)$(am__mv) src/base/$(DEPDIR)/libctemplate_debug_la-arena.Tpo src/base/$(DEPDIR)/libctemplate_debug_la-arena.Plo
#	$(AM_V_CXX)source='src/base/arena.cc' object='src/base/libctemplate_debug_la-arena.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_debug_la_CXXFLAGS) $(CXXFLAGS) -c -o src/base/libctemplate_debug_la-arena.lo `test -f 'src/base/arena.cc' || echo '$(srcdir)/'`src/base/arena.cc
...
src/libctemplate_debug_la-per_expand_data.lo: src/per_expand_data.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_debug_la-per_expand_data.Tpo src/$(DEPDIR)/libctemplate_debug_la-per_expand_data.Plo
#	$(AM_V_CXX)source='src/per_expand_data.cc' object='src/libctemplate_debug_la-per_expand_data.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_debug_la_CXXFLAGS) $(CXXFLAGS) -c -o src/libctemplate_debug_la-per_expand_data.lo `test -f 'src/per_expand_data.cc' || echo '$(srcdir)/'`src/per_expand_data.cc
...
src/libctemplate_debug_la-template.lo: src/template.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_debug_la-template.Tpo src/$(DEPDIR)/libctemplate_debug_la-template.Plo
#	$(AM_V_CXX)source='src/template.cc' object='src/libctemplate_debug_la-template.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_debug_la_CXXFLAGS) $(CXXFLAGS) -c -o src/libctemplate_debug_la-template.lo `test -f 'src/template.cc' || echo '$(srcdir)/'`src/template.cc
...
src/libctemplate_debug_la-template_annotator.lo: src/template_annotator.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_debug_la-template_annotator.Tpo src/$(DEPDIR)/libctemplate_debug_la-template_annotator.Plo
#	$(AM_V_CXX)source='src/template_annotator.cc' object='src/libctemplate_debug_la-template_annotator.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_debug_la_CXXFLAGS) $(CXXFLAGS) -c -o src/libctemplate_debug_la-template_annotator.lo `test -f 'src/template_annotator.cc' || echo '$(srcdir)/'`src/template_annotator.cc
...
src/libctemplate_debug_la-template_cache.lo: src/template_cache.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_debug_la-template_cache.Tpo src/$(DEPDIR)/libctemplate_debug_la-template_cache.Plo
#	$(AM_V_CXX)source='src/template_cache.cc' object='src/libctemplate_debug_la-template_cache.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_debug_la_CXXFLAGS) $(CXXFLAGS) -c -o src/libctemplate_debug_la-template_cache.lo `test -f 'src/template_cache.cc' || echo '$(srcdir)/'`src/template_cache.cc
...
src/libctemplate_debug_la-template_dictionary.lo: src/template_dictionary.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_debug_la-template_dictionary.Tpo src/$(DEPDIR)/libctemplate_debug_la-template_dictionary.Plo
#	$(AM_V_CXX)source='src/template_dictionary.cc' object='src/libctemplate_debug_la-template_dictionary.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_debug_la_CXXFLAGS) $(CXXFLAGS) -c -o src/libctemplate_debug_la-template_dictionary.lo `test -f 'src/template_dictionary.cc' || echo '$(srcdir)/'`src/template_dictionary.cc
...
src/libctemplate_debug_la-template_modifiers.lo: src/template_modifiers.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_debug_la-template_modifiers.Tpo src/$(DEPDIR)/libctemplate_debug_la-template_modifiers.Plo
#	$(AM_V_CXX)source='src/template_modifiers.cc' object='src/libctemplate_debug_la-template_modifiers.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_debug_la_CXXFLAGS) $(CXXFLAGS) -c -o src/libctemplate_debug_la-template_modifiers.lo `test -f 'src/template_modifiers.cc' || echo '$(srcdir)/'`src/template_modifiers.cc
...
src/libctemplate_debug_la-template_namelist.lo: src/template_namelist.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_debug_la-template_namelist.Tpo src/$(DEPDIR)/libctemplate_debug_la-template_namelist.Plo
#	$(AM_V_CXX)source='src/template_namelist.cc' object='src/libctemplate_debug_la-template_namelist.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_debug_la_CXXFLAGS) $(CXXFLAGS) -c -o src/libctemplate_debug_la-template_namelist.lo `test -f 'src/template_namelist.cc' || echo '$(srcdir)/'`src/template_namelist.cc
...
src/libctemplate_debug_la-template_pathops.lo: src/template_pathops.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_debug_la-template_pathops.Tpo src/$(DEPDIR)/libctemplate_debug_la-template_pathops.Plo
#	$(AM_V_CXX)source='src/template_pathops.cc' object='src/libctemplate_debug_la-template_pathops.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_debug_la_CXXFLAGS) $(CXXFLAGS) -c -o src/libctemplate_debug_la-template_pathops.lo `test -f 'src/template_pathops.cc' || echo '$(srcdir)/'`src/template_pathops.cc
...
src/libctemplate_debug_la-template_string.lo: src/template_string.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_debug_la-template_string.Tpo src/$(DEPDIR)/libctemplate_debug_la-template_string.Plo
#	$(AM_V_CXX)source='src/template_string.cc' object='src/libctemplate_debug_la-template_string.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_debug_la_CXXFLAGS) $(CXXFLAGS) -c -o src/libctemplate_debug_la-template_string.lo `test -f 'src/template_string.cc' || echo '$(srcdir)/'`src/template_string.cc
...
src/htmlparser/libctemplate_debug_la-htmlparser.lo: src/htmlparser/htmlparser.cc
	...
	$(AM_V_at)$(am__mv) src/htmlparser/$(DEPDIR)/libctemplate_debug_la-htmlparser.Tpo src/htmlparser/$(DEPDIR)/libctemplate_debug_la-htmlparser.Plo
#	$(AM_V_CXX)source='src/htmlparser/htmlparser.cc' object='src/htmlparser/libctemplate_debug_la-htmlparser.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
src/htmlparser/libctemplate_debug_la-jsparser.lo: src/htmlparser/jsparser.cc
	...
	$(AM_V_at)$(am__mv) src/htmlparser/$(DEPDIR)/libctemplate_debug_la-jsparser.Tpo src/htmlparser/$(DEPDIR)/libctemplate_debug_la-jsparser.Plo
#	$(AM_V_CXX)source='src/htmlparser/jsparser.cc' object='src/htmlparser/libctemplate_debug_la-jsparser.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_debug_la_CXXFLAGS) $(CXXFLAGS) -c -o src/htmlparser/libctemplate_debug_la-jsparser.lo `test -f 'src/htmlparser/jsparser.cc' || echo '$(srcdir)/'`src/htmlparser/jsparser.cc
...
src/htmlparser/libctemplate_debug_la-statemachine.lo: src/htmlparser/statemachine.cc
	...
	$(AM_V_at)$(am__mv) src/htmlparser/$(DEPDIR)/libctemplate_debug_la-statemachine.Tpo src/htmlparser/$(DEPDIR)/libctemplate_debug_la-statemachine.Plo
#	$(AM_V_CXX)source='src/htmlparser/statemachine.cc' object='src/htmlparser/libctemplate_debug_la-statemachine.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
src/windows/libctemplate_debug_la-port.lo: src/windows/port.cc
	...
	$(AM_V_at)$(am__mv) src/windows/$(DEPDIR)/libctemplate_debug_la-port.Tpo src/windows/$(DEPDIR)/libctemplate_debug_la-port.Plo
#	$(AM_V_CXX)source='src/windows/port.cc' object='src/windows/libctemplate_debug_la-port.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_debug_la_CXXFLAGS) $(CXXFLAGS) -c -o src/windows/libctemplate_debug_la-port.lo `test -f 'src/windows/port.cc' || echo '$(srcdir)/'`src/windows/port.cc
...
src/base/libctemplate_nothreads_la-arena.lo: src/base/arena.cc
	...
	$(AM_V_at)$(am__mv) src/base/$(DEPDIR)/libctemplate_nothreads_la-arena.Tpo src/base/$(DEPDIR)/libctemplate_nothreads_la-arena.Plo
#	$(AM_V_CXX)source='src/base/arena.cc' object='src/base/libctemplate_nothreads_la-arena.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_nothreads_la_CXXFLAGS) $(CXXFLAGS) -c -o src/base/libctemplate_nothreads_la-arena.lo `test -f 'src/base/arena.cc' || echo '$(srcdir)/'`src/base/arena.cc
...
src/libctemplate_nothreads_la-per_expand_data.lo: src/per_expand_data.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_nothreads_la-per_expand_data.Tpo src/$(DEPDIR)/libctemplate_nothreads_la-per_expand_data.Plo
#	$(AM_V_CXX)source='src/per_expand_data.cc' object='src/libctemplate_nothreads_la-per_expand_data.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_nothreads_la_CXXFLAGS) $(CXXFLAGS) -c -o src/libctemplate_nothreads_la-per_expand_data.lo `test -f 'src/per_expand_data.cc' || echo '$(srcdir)/'`src/per_expand_data.cc
...
src/libctemplate_nothreads_la-template.lo: src/template.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_nothreads_la-template.Tpo src/$(DEPDIR)/libctemplate_nothreads_la-template.Plo
#	$(AM_V_CXX)source='src/template.cc' object='src/libctemplate_nothreads_la-template.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_nothreads_la_CXXFLAGS) $(CXXFLAGS) -c -o src/libctemplate_nothreads_la-template.lo `test -f 'src/template.cc' || echo '$(srcdir)/'`src/template.cc
...
src/libctemplate_nothreads_la-template_annotator.lo: src/template_annotator.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_nothreads_la-template_annotator.Tpo src/$(DEPDIR)/libctemplate_nothreads_la-template_annotator.Plo
#	$(AM_V_CXX)source='src/template_annotator.cc' object='src/libctemplate_nothreads_la-template_annotator.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
src/libctemplate_nothreads_la-template_cache.lo: src/template_cache.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_nothreads_la-template_cache.Tpo src/$(DEPDIR)/libctemplate_nothreads_la-template_cache.Plo
#	$(AM_V_CXX)source='src/template_cache.cc' object='src/libctemplate_nothreads_la-template_cache.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_nothreads_la_CXXFLAGS) $(CXXFLAGS) -c -o src/libctemplate_nothreads_la-template_cache.lo `test -f 'src/template_cache.cc' || echo '$(srcdir)/'`src/template_cache.cc
...
src/libctemplate_nothreads_la-template_dictionary.lo: src/template_dictionary.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_nothreads_la-template_dictionary.Tpo src/$(DEPDIR)/libctemplate_nothreads_la-template_dictionary.Plo
#	$(AM_V_CXX)source='src/template_dictionary.cc' object='src/libctemplate_nothreads_la-template_dictionary.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
src/libctemplate_nothreads_la-template_modifiers.lo: src/template_modifiers.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_nothreads_la-template_modifiers.Tpo src/$(DEPDIR)/libctemplate_nothreads_la-template_modifiers.Plo
#	$(AM_V_CXX)source='src/template_modifiers.cc' object='src/libctemplate_nothreads_la-template_modifiers.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
src/libctemplate_nothreads_la-template_namelist.lo: src/template_namelist.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_nothreads_la-template_namelist.Tpo src/$(DEPDIR)/libctemplate_nothreads_la-template_namelist.Plo
#	$(AM_V_CXX)source='src/template_namelist.cc' object='src/libctemplate_nothreads_la-template_namelist.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
src/libctemplate_nothreads_la-template_pathops.lo: src/template_pathops.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_nothreads_la-template_pathops.Tpo src/$(DEPDIR)/libctemplate_nothreads_la-template_pathops.Plo
#	$(AM_V_CXX)source='src/template_pathops.cc' object='src/libctemplate_nothreads_la-template_pathops.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_nothreads_la_CXXFLAGS) $(CXXFLAGS) -c -o src/libctemplate_nothreads_la-template_pathops.lo `test -f 'src/template_pathops.cc' || echo '$(srcdir)/'`src/template_pathops.cc
...
src/libctemplate_nothreads_la-template_string.lo: src/template_string.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_nothreads_la-template_string.Tpo src/$(DEPDIR)/libctemplate_nothreads_la-template_string.Plo
#	$(AM_V_CXX)source='src/template_string.cc' object='src/libctemplate_nothreads_la-template_string.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_nothreads_la_CXXFLAGS) $(CXXFLAGS) -c -o src/libctemplate_nothreads_la-template_string.lo `test -f 'src/template_string.cc' || echo '$(srcdir)/'`src/template_string.cc
...
src/htmlparser/libctemplate_nothreads_la-htmlparser.lo: src/htmlparser/htmlparser.cc
	...
	$(AM_V_at)$(am__mv) src/htmlparser/$(DEPDIR)/libctemplate_nothreads_la-htmlparser.Tpo src/htmlparser/$(DEPDIR)/libctemplate_nothreads_la-htmlparser.Plo
#	$(AM_V_CXX)source='src/htmlparser/htmlparser.cc' object='src/htmlparser/libctemplate_nothreads_la-htmlparser.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
src/htmlparser/libctemplate_nothreads_la-jsparser.lo: src/htmlparser/jsparser.cc
	...
	$(AM_V_at)$(am__mv) src/htmlparser/$(DEPDIR)/libctemplate_nothreads_la-jsparser.Tpo src/htmlparser/$(DEPDIR)/libctemplate_nothreads_la-jsparser.Plo
#	$(AM_V_CXX)source='src/htmlparser/jsparser.cc' object='src/htmlparser/libctemplate_nothreads_la-jsparser.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
src/htmlparser/libctemplate_nothreads_la-statemachine.lo: src/htmlparser/statemachine.cc
	...
	$(AM_V_at)$(am__mv) src/htmlparser/$(DEPDIR)/libctemplate_nothreads_la-statemachine.Tpo src/htmlparser/$(DEPDIR)/libctemplate_nothreads_la-statemachine.Plo
#	$(AM_V_CXX)source='src/htmlparser/statemachine.cc' object='src/htmlparser/libctemplate_nothreads_la-statemachine.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
src/windows/libctemplate_nothreads_la-port.lo: src/windows/port.cc
	...
	$(AM_V_at)$(am__mv) src/windows/$(DEPDIR)/libctemplate_nothreads_la-port.Tpo src/windows/$(DEPDIR)/libctemplate_nothreads_la-port.Plo
#	$(AM_V_CXX)source='src/windows/port.cc' object='src/windows/libctemplate_nothreads_la-port.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_nothreads_la_CXXFLAGS) $(CXXFLAGS) -c -o src/windows/libctemplate_nothreads_la-port.lo `test -f 'src/windows/port.cc' || echo '$(srcdir)/'`src/windows/port.cc
...
src/base/libctemplate_nothreads_debug_la-arena.lo: src/base/arena.cc
	...
	$(AM_V_at)$(am__mv) src/base/$(DEPDIR)/libctemplate_nothreads_debug_la-arena.Tpo src/base/$(DEPDIR)/libctemplate_nothreads_debug_la-arena.Plo
#	$(AM_V_CXX)source='src/base/arena.cc' object='src/base/libctemplate_nothreads_debug_la-arena.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_nothreads_debug_la_CXXFLAGS) $(CXXFLAGS) -c -o src/base/libctemplate_nothreads_debug_la-arena.lo `test -f 'src/base/arena.cc' || echo '$(srcdir)/'`src/base/arena.cc
...
src/libctemplate_nothreads_debug_la-per_expand_data.lo: src/per_expand_data.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_nothreads_debug_la-per_expand_data.Tpo src/$(DEPDIR)/libctemplate_nothreads_debug_la-per_expand_data.Plo
#	$(AM_V_CXX)source='src/per_expand_data.cc' object='src/libctemplate_nothreads_debug_la-per_expand_data.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
src/libctemplate_nothreads_debug_la-template.lo: src/template.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_nothreads_debug_la-template.Tpo src/$(DEPDIR)/libctemplate_nothreads_debug_la-template.Plo
#	$(AM_V_CXX)source='src/template.cc' object='src/libctemplate_nothreads_debug_la-template.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_nothreads_debug_la_CXXFLAGS) $(CXXFLAGS) -c -o src/libctemplate_nothreads_debug_la-template.lo `test -f 'src/template.cc' || echo '$(srcdir)/'`src/template.cc
...
src/libctemplate_nothreads_debug_la-template_annotator.lo: src/template_annotator.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_annotator.Tpo src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_annotator.Plo
#	$(AM_V_CXX)source='src/template_annotator.cc' object='src/libctemplate_nothreads_debug_la-template_annotator.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_nothreads_debug_la_CXXFLAGS) $(CXXFLAGS) -c -o src/libctemplate_nothreads_debug_la-template_annotator.lo `test -f 'src/template_annotator.cc' || echo '$(srcdir)/'`src/template_annotator.cc
...
src/libctemplate_nothreads_debug_la-template_cache.lo: src/template_cache.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_cache.Tpo src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_cache.Plo
#	$(AM_V_CXX)source='src/template_cache.cc' object='src/libctemplate_nothreads_debug_la-template_cache.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_nothreads_debug_la_CXXFLAGS) $(CXXFLAGS) -c -o src/libctemplate_nothreads_debug_la-template_cache.lo `test -f 'src/template_cache.cc' || echo '$(srcdir)/'`src/template_cache.cc
...
src/libctemplate_nothreads_debug_la-template_dictionary.lo: src/template_dictionary.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_dictionary.Tpo src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_dictionary.Plo
#	$(AM_V_CXX)source='src/template_dictionary.cc' object='src/libctemplate_nothreads_debug_la-template_dictionary.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_nothreads_debug_la_CXXFLAGS) $(CXXFLAGS) -c -o src/libctemplate_nothreads_debug_la-template_dictionary.lo `test -f 'src/template_dictionary.cc' || echo '$(srcdir)/'`src/template_dictionary.cc
...
src/libctemplate_nothreads_debug_la-template_modifiers.lo: src/template_modifiers.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_modifiers.Tpo src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_modifiers.Plo
#	$(AM_V_CXX)source='src/template_modifiers.cc' object='src/libctemplate_nothreads_debug_la-template_modifiers.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_nothreads_debug_la_CXXFLAGS) $(CXXFLAGS) -c -o src/libctemplate_nothreads_debug_la-template_modifiers.lo `test -f 'src/template_modifiers.cc' || echo '$(srcdir)/'`src/template_modifiers.cc
...
src/libctemplate_nothreads_debug_la-template_namelist.lo: src/template_namelist.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_namelist.Tpo src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_namelist.Plo
#	$(AM_V_CXX)source='src/template_namelist.cc' object='src/libctemplate_nothreads_debug_la-template_namelist.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_nothreads_debug_la_CXXFLAGS) $(CXXFLAGS) -c -o src/libctemplate_nothreads_debug_la-template_namelist.lo `test -f 'src/template_namelist.cc' || echo '$(srcdir)/'`src/template_namelist.cc
...
src/libctemplate_nothreads_debug_la-template_pathops.lo: src/template_pathops.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_pathops.Tpo src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_pathops.Plo
#	$(AM_V_CXX)source='src/template_pathops.cc' object='src/libctemplate_nothreads_debug_la-template_pathops.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_nothreads_debug_la_CXXFLAGS) $(CXXFLAGS) -c -o src/libctemplate_nothreads_debug_la-template_pathops.lo `test -f 'src/template_pathops.cc' || echo '$(srcdir)/'`src/template_pathops.cc
...
src/libctemplate_nothreads_debug_la-template_string.lo: src/template_string.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_string.Tpo src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_string.Plo
#	$(AM_V_CXX)source='src/template_string.cc' object='src/libctemplate_nothreads_debug_la-template_string.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_nothreads_debug_la_CXXFLAGS) $(CXXFLAGS) -c -o src/libctemplate_nothreads_debug_la-template_string.lo `test -f 'src/template_string.cc' || echo '$(srcdir)/'`src/template_string.cc
...
src/htmlparser/libctemplate_nothreads_debug_la-htmlparser.lo: src/htmlparser/htmlparser.cc
	...
	$(AM_V_at)$(am__mv) src/htmlparser/$(DEPDIR)/libctemplate_nothreads_debug_la-htmlparser.Tpo src/htmlparser/$(DEPDIR)/libctemplate_nothreads_debug_la-htmlparser.Plo
#	$(AM_V_CXX)source='src/htmlparser/htmlparser.cc' object='src/htmlparser/libctemplate_nothreads_debug_la-htmlparser.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
src/htmlparser/libctemplate_nothreads_debug_la-jsparser.lo: src/htmlparser/jsparser.cc
	...
	$(AM_V_at)$(am__mv) src/htmlparser/$(DEPDIR)/libctemplate_nothreads_debug_la-jsparser.Tpo src/htmlparser/$(DEPDIR)/libctemplate_nothreads_debug_la-jsparser.Plo
#	$(AM_V_CXX)source='src/htmlparser/jsparser.cc' object='src/htmlparser/libctemplate_nothreads_debug_la-jsparser.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
src/htmlparser/libctemplate_nothreads_debug_la-statemachine.lo: src/htmlparser/statemachine.cc
	...
	$(AM_V_at)$(am__mv) src/htmlparser/$(DEPDIR)/libctemplate_nothreads_debug_la-statemachine.Tpo src/htmlparser/$(DEPDIR)/libctemplate_nothreads_debug_la-statemachine.Plo
#	$(AM_V_CXX)source='src/htmlparser/statemachine.cc' object='src/htmlparser/libctemplate_nothreads_debug_la-statemachine.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
src/windows/libctemplate_nothreads_debug_la-port.lo: src/windows/port.cc
	...
	$(AM_V_at)$(am__mv) src/windows/$(DEPDIR)/libctemplate_nothreads_debug_la-port.Tpo src/windows/$(DEPDIR)/libctemplate_nothreads_debug_la-port.Plo
#	$(AM_V_CXX)source='src/windows/port.cc' object='src/windows/libctemplate_nothreads_debug_la-port.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libctemplate_nothreads_debug_la_CXXFLAGS) $(CXXFLAGS) -c -o src/windows/libctemplate_nothreads_debug_la-port.lo `test -f 'src/windows/port.cc' || echo '$(srcdir)/'`src/windows/port.cc
...
src/tests/libctemplate_testing_la-template_test_util.lo: src/tests/template_test_util.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/libctemplate_testing_la-template_test_util.Tpo src/tests/$(DEPDIR)/libctemplate_testing_la-template_test_util.Plo
#	$(AM_V_CXX)source='src/tests/template_test_util.cc' object='src/tests/libctemplate_testing_la-template_test_util.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
src/tests/libctemplate_testing_nothreads_la-template_test_util.lo: src/tests/template_test_util.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/libctemplate_testing_nothreads_la-template_test_util.Tpo src/tests/$(DEPDIR)/libctemplate_testing_nothreads_la-template_test_util.Plo
#	$(AM_V_CXX)source='src/tests/template_test_util.cc' object='src/tests/libctemplate_testing_nothreads_la-template_test_util.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
#	$(AM_V_CXX)source='src/tests/compile_test.cc' object='src/tests/compile_nothreads_test-compile_test.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(compile_nothreads_test_CXXFLAGS) $(CXXFLAGS) -c -o src/tests/compile_nothreads_test-compile_test.o `test -f 'src/tests/compile_test.cc' || echo '$(srcdir)/'`src/tests/compile_test.cc
...
src/tests/compile_nothreads_test-compile_test.obj: src/tests/compile_test.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/compile_nothreads_test-compile_test.Tpo src/tests/$(DEPDIR)/compile_nothreads_test-compile_test.Po
#	$(AM_V_CXX)source='src/tests/compile_test.cc' object='src/tests/compile_nothreads_test-compile_test.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(compile_nothreads_test_CXXFLAGS) $(CXXFLAGS) -c -o src/tests/compile_nothreads_test-compile_test.obj `if test -f 'src/tests/compile_test.cc'; then $(CYGPATH_W) 'src/tests/compile_test.cc'; else $(CYGPATH_W) '$(srcdir)/src/tests/compile_test.cc'; fi`
...
#	$(AM_V_CXX)source='src/tests/compile_test.cc' object='src/tests/compile_test-compile_test.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(compile_test_CXXFLAGS) $(CXXFLAGS) -c -o src/tests/compile_test-compile_test.o `test -f 'src/tests/compile_test.cc' || echo '$(srcdir)/'`src/tests/compile_test.cc
...
src/tests/compile_test-compile_test.obj: src/tests/compile_test.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/compile_test-compile_test.Tpo src/tests/$(DEPDIR)/compile_test-compile_test.Po
#	$(AM_V_CXX)source='src/tests/compile_test.cc' object='src/tests/compile_test-compile_test.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(compile_test_CXXFLAGS) $(CXXFLAGS) -c -o src/tests/compile_test-compile_test.obj `if test -f 'src/tests/compile_test.cc'; then $(CYGPATH_W) 'src/tests/compile_test.cc'; else $(CYGPATH_W) '$(srcdir)/src/tests/compile_test.cc'; fi`
...
src/tests/htmlparser_nothreads_test-htmlparser_cpp_test.o: src/tests/htmlparser_cpp_test.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/htmlparser_nothreads_test-htmlparser_cpp_test.Tpo src/tests/$(DEPDIR)/htmlparser_nothreads_test-htmlparser_cpp_test.Po
#	$(AM_V_CXX)source='src/tests/htmlparser_cpp_test.cc' object='src/tests/htmlparser_nothreads_test-htmlparser_cpp_test.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(htmlparser_nothreads_test_CXXFLAGS) $(CXXFLAGS) -c -o src/tests/htmlparser_nothreads_test-htmlparser_cpp_test.o `test -f 'src/tests/htmlparser_cpp_test.cc' || echo '$(srcdir)/'`src/tests/htmlparser_cpp_test.cc
...
src/tests/htmlparser_nothreads_test-htmlparser_cpp_test.obj: src/tests/htmlparser_cpp_test.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/htmlparser_nothreads_test-htmlparser_cpp_test.Tpo src/tests/$(DEPDIR)/htmlparser_nothreads_test-htmlparser_cpp_test.Po
#	$(AM_V_CXX)source='src/tests/htmlparser_cpp_test.cc' object='src/tests/htmlparser_nothreads_test-htmlparser_cpp_test.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
src/tests/htmlparser_test-htmlparser_cpp_test.o: src/tests/htmlparser_cpp_test.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/htmlparser_test-htmlparser_cpp_test.Tpo src/tests/$(DEPDIR)/htmlparser_test-htmlparser_cpp_test.Po
#	$(AM_V_CXX)source='src/tests/htmlparser_cpp_test.cc' object='src/tests/htmlparser_test-htmlparser_cpp_test.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(htmlparser_test_CXXFLAGS) $(CXXFLAGS) -c -o src/tests/htmlparser_test-htmlparser_cpp_test.o `test -f 'src/tests/htmlparser_cpp_test.cc' || echo '$(srcdir)/'`src/tests/htmlparser_cpp_test.cc
...
src/tests/htmlparser_test-htmlparser_cpp_test.obj: src/tests/htmlparser_cpp_test.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/htmlparser_test-htmlparser_cpp_test.Tpo src/tests/$(DEPDIR)/htmlparser_test-htmlparser_cpp_test.Po
#	$(AM_V_CXX)source='src/tests/htmlparser_cpp_test.cc' object='src/tests/htmlparser_test-htmlparser_cpp_test.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
src/tests/template_cache_nothreads_test-template_cache_test.o: src/tests/template_cache_test.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/template_cache_nothreads_test-template_cache_test.Tpo src/tests/$(DEPDIR)/template_cache_nothreads_test-template_cache_test.Po
#	$(AM_V_CXX)source='src/tests/template_cache_test.cc' object='src/tests/template_cache_nothreads_test-template_cache_test.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(template_cache_nothreads_test_CXXFLAGS) $(CXXFLAGS) -c -o src/tests/template_cache_nothreads_test-template_cache_test.o `test -f 'src/tests/template_cache_test.cc' || echo '$(srcdir)/'`src/tests/template_cache_test.cc
...
src/tests/template_cache_nothreads_test-template_cache_test.obj: src/tests/template_cache_test.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/template_cache_nothreads_test-template_cache_test.Tpo src/tests/$(DEPDIR)/template_cache_nothreads_test-template_cache_test.Po
#	$(AM_V_CXX)source='src/tests/template_cache_test.cc' object='src/tests/template_cache_nothreads_test-template_cache_test.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
src/tests/template_cache_test-template_cache_test.o: src/tests/template_cache_test.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/template_cache_test-template_cache_test.Tpo src/tests/$(DEPDIR)/template_cache_test-template_cache_test.Po
#	$(AM_V_CXX)source='src/tests/template_cache_test.cc' object='src/tests/template_cache_test-template_cache_test.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(template_cache_test_CXXFLAGS) $(CXXFLAGS) -c -o src/tests/template_cache_test-template_cache_test.o `test -f 'src/tests/template_cache_test.cc' || echo '$(srcdir)/'`src/tests/template_cache_test.cc
...
src/tests/template_cache_test-template_cache_test.obj: src/tests/template_cache_test.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/template_cache_test-template_cache_test.Tpo src/tests/$(DEPDIR)/template_cache_test-template_cache_test.Po
#	$(AM_V_CXX)source='src/tests/template_cache_test.cc' object='src/tests/template_cache_test-template_cache_test.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
src/tests/template_dictionary_nothreads_unittest-template_dictionary_unittest.o: src/tests/template_dictionary_unittest.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/template_dictionary_nothreads_unittest-template_dictionary_unittest.Tpo src/tests/$(DEPDIR)/template_dictionary_nothreads_unittest-template_dictionary_unittest.Po
#	$(AM_V_CXX)source='src/tests/template_dictionary_unittest.cc' object='src/tests/template_dictionary_nothreads_unittest-template_dictionary_unittest.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
src/tests/template_dictionary_nothreads_unittest-template_dictionary_unittest.obj: src/tests/template_dictionary_unittest.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/template_dictionary_nothreads_unittest-template_dictionary_unittest.Tpo src/tests/$(DEPDIR)/template_dictionary_nothreads_unittest-template_dictionary_unittest.Po
#	$(AM_V_CXX)source='src/tests/template_dictionary_unittest.cc' object='src/tests/template_dictionary_nothreads_unittest-template_dictionary_unittest.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(template_dictionary_nothreads_unittest_CXXFLAGS) $(CXXFLAGS) -c -o src/tests/template_dictionary_nothreads_unittest-template_dictionary_unittest.obj `if test -f 'src/tests/template_dictionary_unittest.cc'; then $(CYGPATH_W) 'src/tests/template_dictionary_unittest.cc'; else $(CYGPATH_W) '$(srcdir)/src/tests/template_dictionary_unittest.cc'; fi`
...
src/tests/template_dictionary_unittest-template_dictionary_unittest.o: src/tests/template_dictionary_unittest.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/template_dictionary_unittest-template_dictionary_unittest.Tpo src/tests/$(DEPDIR)/template_dictionary_unittest-template_dictionary_unittest.Po
#	$(AM_V_CXX)source='src/tests/template_dictionary_unittest.cc' object='src/tests/template_dictionary_unittest-template_dictionary_unittest.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(template_dictionary_unittest_CXXFLAGS) $(CXXFLAGS) -c -o src/tests/template_dictionary_unittest-template_dictionary_unittest.o `test -f 'src/tests/template_dictionary_unittest.cc' || echo '$(srcdir)/'`src/tests/template_dictionary_unittest.cc
...
src/tests/template_dictionary_unittest-template_dictionary_unittest.obj: src/tests/template_dictionary_unittest.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/template_dictionary_unittest-template_dictionary_unittest.Tpo src/tests/$(DEPDIR)/template_dictionary_unittest-template_dictionary_unittest.Po
#	$(AM_V_CXX)source='src/tests/template_dictionary_unittest.cc' object='src/tests/template_dictionary_unittest-template_dictionary_unittest.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
src/tests/template_modifiers_nothreads_unittest-template_modifiers_unittest.o: src/tests/template_modifiers_unittest.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/template_modifiers_nothreads_unittest-template_modifiers_unittest.Tpo src/tests/$(DEPDIR)/template_modifiers_nothreads_unittest-template_modifiers_unittest.Po
#	$(AM_V_CXX)source='src/tests/template_modifiers_unittest.cc' object='src/tests/template_modifiers_nothreads_unittest-template_modifiers_unittest.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
src/tests/template_modifiers_nothreads_unittest-template_modifiers_unittest.obj: src/tests/template_modifiers_unittest.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/template_modifiers_nothreads_unittest-template_modifiers_unittest.Tpo src/tests/$(DEPDIR)/template_modifiers_nothreads_unittest-template_modifiers_unittest.Po
#	$(AM_V_CXX)source='src/tests/template_modifiers_unittest.cc' object='src/tests/template_modifiers_nothreads_unittest-template_modifiers_unittest.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
src/tests/template_modifiers_unittest-template_modifiers_unittest.o: src/tests/template_modifiers_unittest.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/template_modifiers_unittest-template_modifiers_unittest.Tpo src/tests/$(DEPDIR)/template_modifiers_unittest-template_modifiers_unittest.Po
#	$(AM_V_CXX)source='src/tests/template_modifiers_unittest.cc' object='src/tests/template_modifiers_unittest-template_modifiers_unittest.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(template_modifiers_unittest_CXXFLAGS) $(CXXFLAGS) -c -o src/tests/template_modifiers_unittest-template_modifiers_unittest.o `test -f 'src/tests/template_modifiers_unittest.cc' || echo '$(srcdir)/'`src/tests/template_modifiers_unittest.cc
...
src/tests/template_modifiers_unittest-template_modifiers_unittest.obj: src/tests/template_modifiers_unittest.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/template_modifiers_unittest-template_modifiers_unittest.Tpo src/tests/$(DEPDIR)/template_modifiers_unittest-template_modifiers_unittest.Po
#	$(AM_V_CXX)source='src/tests/template_modifiers_unittest.cc' object='src/tests/template_modifiers_unittest-template_modifiers_unittest.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
src/tests/template_nothreads_regtest-template_regtest.o: src/tests/template_regtest.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/template_nothreads_regtest-template_regtest.Tpo src/tests/$(DEPDIR)/template_nothreads_regtest-template_regtest.Po
#	$(AM_V_CXX)source='src/tests/template_regtest.cc' object='src/tests/template_nothreads_regtest-template_regtest.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(template_nothreads_regtest_CXXFLAGS) $(CXXFLAGS) -c -o src/tests/template_nothreads_regtest-template_regtest.o `test -f 'src/tests/template_regtest.cc' || echo '$(srcdir)/'`src/tests/template_regtest.cc
...
src/tests/template_nothreads_regtest-template_regtest.obj: src/tests/template_regtest.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/template_nothreads_regtest-template_regtest.Tpo src/tests/$(DEPDIR)/template_nothreads_regtest-template_regtest.Po
#	$(AM_V_CXX)source='src/tests/template_regtest.cc' object='src/tests/template_nothreads_regtest-template_regtest.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
src/tests/template_nothreads_unittest-template_unittest.o: src/tests/template_unittest.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/template_nothreads_unittest-template_unittest.Tpo src/tests/$(DEPDIR)/template_nothreads_unittest-template_unittest.Po
#	$(AM_V_CXX)source='src/tests/template_unittest.cc' object='src/tests/template_nothreads_unittest-template_unittest.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(template_nothreads_unittest_CXXFLAGS) $(CXXFLAGS) -c -o src/tests/template_nothreads_unittest-template_unittest.o `test -f 'src/tests/template_unittest.cc' || echo '$(srcdir)/'`src/tests/template_unittest.cc
...
src/tests/template_nothreads_unittest-template_unittest.obj: src/tests/template_unittest.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/template_nothreads_unittest-template_unittest.Tpo src/tests/$(DEPDIR)/template_nothreads_unittest-template_unittest.Po
#	$(AM_V_CXX)source='src/tests/template_unittest.cc' object='src/tests/template_nothreads_unittest-template_unittest.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
src/tests/template_regtest-template_regtest.o: src/tests/template_regtest.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/template_regtest-template_regtest.Tpo src/tests/$(DEPDIR)/template_regtest-template_regtest.Po
#	$(AM_V_CXX)source='src/tests/template_regtest.cc' object='src/tests/template_regtest-template_regtest.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(template_regtest_CXXFLAGS) $(CXXFLAGS) -c -o src/tests/template_regtest-template_regtest.o `test -f 'src/tests/template_regtest.cc' || echo '$(srcdir)/'`src/tests/template_regtest.cc
...
src/tests/template_regtest-template_regtest.obj: src/tests/template_regtest.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/template_regtest-template_regtest.Tpo src/tests/$(DEPDIR)/template_regtest-template_regtest.Po
#	$(AM_V_CXX)source='src/tests/template_regtest.cc' object='src/tests/template_regtest-template_regtest.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(template_regtest_CXXFLAGS) $(CXXFLAGS) -c -o src/tests/template_regtest-template_regtest.obj `if test -f 'src/tests/template_regtest.cc'; then $(CYGPATH_W) 'src/tests/template_regtest.cc'; else $(CYGPATH_W) '$(srcdir)/src/tests/template_regtest.cc'; fi`
...
src/tests/template_setglobals_nothreads_unittest-template_setglobals_unittest.o: src/tests/template_setglobals_unittest.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/template_setglobals_nothreads_unittest-template_setglobals_unittest.Tpo src/tests/$(DEPDIR)/template_setglobals_nothreads_unittest-template_setglobals_unittest.Po
#	$(AM_V_CXX)source='src/tests/template_setglobals_unittest.cc' object='src/tests/template_setglobals_nothreads_unittest-template_setglobals_unittest.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
src/tests/template_setglobals_nothreads_unittest-template_setglobals_unittest.obj: src/tests/template_setglobals_unittest.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/template_setglobals_nothreads_unittest-template_setglobals_unittest.Tpo src/tests/$(DEPDIR)/template_setglobals_nothreads_unittest-template_setglobals_unittest.Po
#	$(AM_V_CXX)source='src/tests/template_setglobals_unittest.cc' object='src/tests/template_setglobals_nothreads_unittest-template_setglobals_unittest.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(template_setglobals_nothreads_unittest_CXXFLAGS) $(CXXFLAGS) -c -o src/tests/template_setglobals_nothreads_unittest-template_setglobals_unittest.obj `if test -f 'src/tests/template_setglobals_unittest.cc'; then $(CYGPATH_W) 'src/tests/template_setglobals_unittest.cc'; else $(CYGPATH_W) '$(srcdir)/src/tests/template_setglobals_unittest.cc'; fi`
...
src/tests/template_setglobals_unittest-template_setglobals_unittest.o: src/tests/template_setglobals_unittest.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/template_setglobals_unittest-template_setglobals_unittest.Tpo src/tests/$(DEPDIR)/template_setglobals_unittest-template_setglobals_unittest.Po
#	$(AM_V_CXX)source='src/tests/template_setglobals_unittest.cc' object='src/tests/template_setglobals_unittest-template_setglobals_unittest.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(template_setglobals_unittest_CXXFLAGS) $(CXXFLAGS) -c -o src/tests/template_setglobals_unittest-template_setglobals_unittest.o `test -f 'src/tests/template_setglobals_unittest.cc' || echo '$(srcdir)/'`src/tests/template_setglobals_unittest.cc
...
src/tests/template_setglobals_unittest-template_setglobals_unittest.obj: src/tests/template_setglobals_unittest.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/template_setglobals_unittest-template_setglobals_unittest.Tpo src/tests/$(DEPDIR)/template_setglobals_unittest-template_setglobals_unittest.Po
#	$(AM_V_CXX)source='src/tests/template_setglobals_unittest.cc' object='src/tests/template_setglobals_unittest-template_setglobals_unittest.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
src/template_test_util_nothreads_test-template_dictionary.o: src/template_dictionary.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/template_test_util_nothreads_test-template_dictionary.Tpo src/$(DEPDIR)/template_test_util_nothreads_test-template_dictionary.Po
#	$(AM_V_CXX)source='src/template_dictionary.cc' object='src/template_test_util_nothreads_test-template_dictionary.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(template_test_util_nothreads_test_CXXFLAGS) $(CXXFLAGS) -c -o src/template_test_util_nothreads_test-template_dictionary.o `test -f 'src/template_dictionary.cc' || echo '$(srcdir)/'`src/template_dictionary.cc
...
src/template_test_util_nothreads_test-template_dictionary.obj: src/template_dictionary.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/template_test_util_nothreads_test-template_dictionary.Tpo src/$(DEPDIR)/template_test_util_nothreads_test-template_dictionary.Po
#	$(AM_V_CXX)source='src/template_dictionary.cc' object='src/template_test_util_nothreads_test-template_dictionary.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
src/tests/template_test_util_nothreads_test-template_test_util_test.o: src/tests/template_test_util_test.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/template_test_util_nothreads_test-template_test_util_test.Tpo src/tests/$(DEPDIR)/template_test_util_nothreads_test-template_test_util_test.Po
#	$(AM_V_CXX)source='src/tests/template_test_util_test.cc' object='src/tests/template_test_util_nothreads_test-template_test_util_test.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(template_test_util_nothreads_test_CXXFLAGS) $(CXXFLAGS) -c -o src/tests/template_test_util_nothreads_test-template_test_util_test.o `test -f 'src/tests/template_test_util_test.cc' || echo '$(srcdir)/'`src/tests/template_test_util_test.cc
...
src/tests/template_test_util_nothreads_test-template_test_util_test.obj: src/tests/template_test_util_test.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/template_test_util_nothreads_test-template_test_util_test.Tpo src/tests/$(DEPDIR)/template_test_util_nothreads_test-template_test_util_test.Po
#	$(AM_V_CXX)source='src/tests/template_test_util_test.cc' object='src/tests/template_test_util_nothreads_test-template_test_util_test.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
src/template_test_util_test-template_dictionary.o: src/template_dictionary.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/template_test_util_test-template_dictionary.Tpo src/$(DEPDIR)/template_test_util_test-template_dictionary.Po
#	$(AM_V_CXX)source='src/template_dictionary.cc' object='src/template_test_util_test-template_dictionary.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(template_test_util_test_CXXFLAGS) $(CXXFLAGS) -c -o src/template_test_util_test-template_dictionary.o `test -f 'src/template_dictionary.cc' || echo '$(srcdir)/'`src/template_dictionary.cc
...
src/template_test_util_test-template_dictionary.obj: src/template_dictionary.cc
	...
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/template_test_util_test-template_dictionary.Tpo src/$(DEPDIR)/template_test_util_test-template_dictionary.Po
#	$(AM_V_CXX)source='src/template_dictionary.cc' object='src/template_test_util_test-template_dictionary.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(template_test_util_test_CXXFLAGS) $(CXXFLAGS) -c -o src/template_test_util_test-template_dictionary.obj `if test -f 'src/template_dictionary.cc'; then $(CYGPATH_W) 'src/template_dictionary.cc'; else $(CYGPATH_W) '$(srcdir)/src/template_dictionary.cc'; fi`
...
src/tests/template_test_util_test-template_test_util_test.o: src/tests/template_test_util_test.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/template_test_util_test-template_test_util_test.Tpo src/tests/$(DEPDIR)/template_test_util_test-template_test_util_test.Po
#	$(AM_V_CXX)source='src/tests/template_test_util_test.cc' object='src/tests/template_test_util_test-template_test_util_test.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(template_test_util_test_CXXFLAGS) $(CXXFLAGS) -c -o src/tests/template_test_util_test-template_test_util_test.o `test -f 'src/tests/template_test_util_test.cc' || echo '$(srcdir)/'`src/tests/template_test_util_test.cc
...
src/tests/template_test_util_test-template_test_util_test.obj: src/tests/template_test_util_test.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/template_test_util_test-template_test_util_test.Tpo src/tests/$(DEPDIR)/template_test_util_test-template_test_util_test.Po
#	$(AM_V_CXX)source='src/tests/template_test_util_test.cc' object='src/tests/template_test_util_test-template_test_util_test.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
src/tests/template_unittest-template_unittest.o: src/tests/template_unittest.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/template_unittest-template_unittest.Tpo src/tests/$(DEPDIR)/template_unittest-template_unittest.Po
#	$(AM_V_CXX)source='src/tests/template_unittest.cc' object='src/tests/template_unittest-template_unittest.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(template_unittest_CXXFLAGS) $(CXXFLAGS) -c -o src/tests/template_unittest-template_unittest.o `test -f 'src/tests/template_unittest.cc' || echo '$(srcdir)/'`src/tests/template_unittest.cc
...
src/tests/template_unittest-template_unittest.obj: src/tests/template_unittest.cc
	...
	$(AM_V_at)$(am__mv) src/tests/$(DEPDIR)/template_unittest-template_unittest.Tpo src/tests/$(DEPDIR)/template_unittest-template_unittest.Po
#	$(AM_V_CXX)source='src/tests/template_unittest.cc' object='src/tests/template_unittest-template_unittest.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(template_unittest_CXXFLAGS) $(CXXFLAGS) -c -o src/tests/template_unittest-template_unittest.obj `if test -f 'src/tests/template_unittest.cc'; then $(CYGPATH_W) 'src/tests/template_unittest.cc'; else $(CYGPATH_W) '$(srcdir)/src/tests/template_unittest.cc'; fi`
...
installdirs:
	for dir in "$(DESTDIR)$(bindir)" "$(DESTDIR)$(libdir)" "$(DESTDIR)$(bindir)" "$(DESTDIR)$(docdir)" "$(DESTDIR)$(pkgconfigdir)" "$(DESTDIR)$(ctemplateincludedir)"; do \
...
distclean: distclean-am
	-rm -f $(am__CONFIG_DISTCLEAN_FILES)
		-rm -f ./$(DEPDIR)/statemachine_test-statemachine.Po
	-rm -f src/$(DEPDIR)/diff_tpl_auto_escape.Po
	-rm -f src/$(DEPDIR)/libctemplate_debug_la-per_expand_data.Plo
	-rm -f src/$(DEPDIR)/libctemplate_debug_la-template.Plo
	-rm -f src/$(DEPDIR)/libctemplate_debug_la-template_annotator.Plo
	-rm -f src/$(DEPDIR)/libctemplate_debug_la-template_cache.Plo
	-rm -f src/$(DEPDIR)/libctemplate_debug_la-template_dictionary.Plo
	-rm -f src/$(DEPDIR)/libctemplate_debug_la-template_modifiers.Plo
	-rm -f src/$(DEPDIR)/libctemplate_debug_la-template_namelist.Plo
	-rm -f src/$(DEPDIR)/libctemplate_debug_la-template_pathops.Plo
	-rm -f src/$(DEPDIR)/libctemplate_debug_la-template_string.Plo
	-rm -f src/$(DEPDIR)/libctemplate_la-per_expand_data.Plo
	-rm -f src/$(DEPDIR)/libctemplate_la-template.Plo
	-rm -f src/$(DEPDIR)/libctemplate_la-template_annotator.Plo
	-rm -f src/$(DEPDIR)/libctemplate_la-template_cache.Plo
	-rm -f src/$(DEPDIR)/libctemplate_la-template_dictionary.Plo
	-rm -f src/$(DEPDIR)/libctemplate_la-template_modifiers.Plo
	-rm -f src/$(DEPDIR)/libctemplate_la-template_namelist.Plo
	-rm -f src/$(DEPDIR)/libctemplate_la-template_pathops.Plo
	-rm -f src/$(DEPDIR)/libctemplate_la-template_string.Plo
	-rm -f src/$(DEPDIR)/libctemplate_nothreads_debug_la-per_expand_data.Plo
	-rm -f src/$(DEPDIR)/libctemplate_nothreads_debug_la-template.Plo
	-rm -f src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_annotator.Plo
	-rm -f src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_cache.Plo
	-rm -f src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_dictionary.Plo
	-rm -f src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_modifiers.Plo
	-rm -f src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_namelist.Plo
	-rm -f src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_pathops.Plo
	-rm -f src/$(DEPDIR)/libctemplate_nothreads_debug_la-template_string.Plo
	-rm -f src/$(DEPDIR)/libctemplate_nothreads_la-per_expand_data.Plo
	-rm -f src/$(DEPDIR)/libctemplate_nothreads_la-template.Plo
	-rm -f src/$(DEPDIR)/libctemplate_nothreads_la-template_annotator.Plo
	-rm -f src/$(DEPDIR)/libctemplate_nothreads_la-template_cache.Plo
	-rm -f src/$(DEPDIR)/libctemplate_nothreads_la-template_dictionary.Plo
	-rm -f src/$(DEPDIR)/libctemplate_nothreads_la-template_modifiers.Plo
	-rm -f src/$(DEPDIR)/libctemplate_nothreads_la-template_namelist.Plo
	-rm -f src/$(DEPDIR)/libctemplate_nothreads_la-template_pathops.Plo
	-rm -f src/$(DEPDIR)/libctemplate_nothreads_la-template_string.Plo
	-rm -f src/$(DEPDIR)/make_tpl_varnames_h.Po
	-rm -f src/$(DEPDIR)/template_test_util_nothreads_test-template_dictionary.Po
	-rm -f src/$(DEPDIR)/template_test_util_test-template_dictionary.Po
	-rm -f src/base/$(DEPDIR)/libctemplate_debug_la-arena.Plo
	-rm -f src/base/$(DEPDIR)/libctemplate_la-arena.Plo
	-rm -f src/base/$(DEPDIR)/libctemplate_nothreads_debug_la-arena.Plo
	-rm -f src/base/$(DEPDIR)/libctemplate_nothreads_la-arena.Plo
	-rm -f src/htmlparser/$(DEPDIR)/libctemplate_debug_la-htmlparser.Plo
	-rm -f src/htmlparser/$(DEPDIR)/libctemplate_debug_la-jsparser.Plo
	-rm -f src/htmlparser/$(DEPDIR)/libctemplate_debug_la-statemachine.Plo
	-rm -f src/htmlparser/$(DEPDIR)/libctemplate_la-htmlparser.Plo
	-rm -f src/htmlparser/$(DEPDIR)/libctemplate_la-jsparser.Plo
	-rm -f src/htmlparser/$(DEPDIR)/libctemplate_la-statemachine.Plo
	-rm -f src/htmlparser/$(DEPDIR)/libctemplate_nothreads_debug_la-htmlparser.Plo
	-rm -f src/htmlparser/$(DEPDIR)/libctemplate_nothreads_debug_la-jsparser.Plo
	-rm -f src/htmlparser/$(DEPDIR)/libctemplate_nothreads_debug_la-statemachine.Plo
	-rm -f src/htmlparser/$(DEPDIR)/libctemplate_nothreads_la-htmlparser.Plo
	-rm -f src/htmlparser/$(DEPDIR)/libctemplate_nothreads_la-jsparser.Plo
	-rm -f src/htmlparser/$(DEPDIR)/libctemplate_nothreads_la-statemachine.Plo
	-rm -f src/tests/$(DEPDIR)/compile_nothreads_test-compile_test.Po
	-rm -f src/tests/$(DEPDIR)/compile_test-compile_test.Po
	-rm -f src/tests/$(DEPDIR)/generate_fsm_c_test.Po
	-rm -f src/tests/$(DEPDIR)/htmlparser_nothreads_test-htmlparser_cpp_test.Po
	-rm -f src/tests/$(DEPDIR)/htmlparser_test-htmlparser_cpp_test.Po
	-rm -f src/tests/$(DEPDIR)/libctemplate_testing_la-template_test_util.Plo
	-rm -f src/tests/$(DEPDIR)/libctemplate_testing_nothreads_la-template_test_util.Plo
	-rm -f src/tests/$(DEPDIR)/statemachine_test-statemachine_test.Po
	-rm -f src/tests/$(DEPDIR)/template_cache_nothreads_test-template_cache_test.Po
	-rm -f src/tests/$(DEPDIR)/template_cache_test-template_cache_test.Po
	-rm -f src/tests/$(DEPDIR)/template_dictionary_nothreads_unittest-template_dictionary_unittest.Po
	-rm -f src/tests/$(DEPDIR)/template_dictionary_unittest-template_dictionary_unittest.Po
	-rm -f src/tests/$(DEPDIR)/template_modifiers_nothreads_unittest-template_modifiers_unittest.Po
	-rm -f src/tests/$(DEPDIR)/template_modifiers_unittest-template_modifiers_unittest.Po
	-rm -f src/tests/$(DEPDIR)/template_nothreads_regtest-template_regtest.Po
	-rm -f src/tests/$(DEPDIR)/template_nothreads_unittest-template_unittest.Po
	-rm -f src/tests/$(DEPDIR)/template_regtest-template_regtest.Po
	-rm -f src/tests/$(DEPDIR)/template_setglobals_nothreads_unittest-template_setglobals_unittest.Po
	-rm -f src/tests/$(DEPDIR)/template_setglobals_unittest-template_setglobals_unittest.Po
	-rm -f src/tests/$(DEPDIR)/template_test_util_nothreads_test-template_test_util_test.Po
	-rm -f src/tests/$(DEPDIR)/template_test_util_test-template_test_util_test.Po
	-rm -f src/tests/$(DEPDIR)/template_unittest-template_unittest.Po
	-rm -f src/windows/$(DEPDIR)/libctemplate_debug_la-port.Plo
	-rm -f src/windows/$(DEPDIR)/libctemplate_la-port.Plo
	-rm -f src/windows/$(DEPDIR)/libctemplate_nothreads_debug_la-port.Plo
	-rm -f src/windows/$(DEPDIR)/libctemplate_nothreads_la-port.Plo
	-rm -f Makefile
